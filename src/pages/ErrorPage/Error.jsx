const Error = () => {
    return (
        <div>
            <div className="h-screen bg-[#FBF7F4] justify-center">
                <center className="pt-24 m-auto">
                    <svg className="emoji-404 "
                    ...
                    <div className=" tracking-widest mt-4">
                        ...
                        <span className="text-xl">Sorry, We couldn't find what you are looking for!</span>

                    </div>
                </center>
                <center className="mt-6">
                    <a href="/" className="font-mono text-xl text-white bg-[#F1615A] p-3 rounded-md hover:shadow-md">Go back </a>
                </center>
            </div>
        </div>
    );
