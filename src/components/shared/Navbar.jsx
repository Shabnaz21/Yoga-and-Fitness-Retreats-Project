...
const Navbar = () => {
    ...
    const menus = <>
        ...
        <li><NavLink to='/offers'>Exclusive offer</NavLink> </li>
        <li><NavLink to='/register'>Register</NavLink> </li>
    </>
    return (
        <div className="light:bg-[#E3F2F1] night:bg-black ">
                ...
                <div className="navbar-end gap-4">
                    <div>
                        {user ? (
                                ...
                                <div className="flex-none gap-2">
                                    <div className="dropdown dropdown-end">
                                        ...
                                        <ul tabIndex={0} className="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52">
                                            <li><p className="text-gray-700 font-semibold">{user.displayName}</p></li>
                                            <li>
                            ...
                            <Link to='/login' className="btn bg-[#F1615A] text-white 
                             hover:bg-slate-800 hover:text-white normal-case">Login</Link>
                        )}
                    </div>
                    <div>
                        {themeToggler}
